...
class Olympiad(CommonObject):
    ...
    location = CharField(verbose_name="Место проведения", max_length=255, null=True, blank=True)
...
class OlympiadParticipation(CommonObject):
    ...
    award = CharField(verbose_name="Награда", max_length=255, null=True, blank=True)
