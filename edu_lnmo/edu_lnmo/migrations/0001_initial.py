...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('GEN', 'Общая'), ('ART', 'Статья'), ('TSK', 'Задание'), ('LNK', 'Ссылка'), ('MED', 'Медиа-контент')], default='GEN', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finishing_class', models.IntegerField(blank=True, null=True, verbose_name='Класс завершения')),
        ...
        migrations.AddField(
            model_name='activity',
            name='files',
            field=models.ManyToManyField(blank=True, to='edu_lnmo.file', verbose_name='Вложения/файлы'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='edu_lnmo.activity', verbose_name='Задание')),
            ],
            options={
                'abstract': False,
            },
