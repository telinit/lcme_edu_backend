    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('type', models.CharField(choices=[('GEN', 'Общая'), ('ART', 'Статья'), ('TSK', 'Задание'), ('LNK', 'Ссылка'), ('MED', 'Медиа-контент'), ('FIN', 'Итоговый контроль')], default='GEN', max_length=3)),
                ...
                ('order', models.IntegerField(unique=True, verbose_name='Номер в списке курса')),
        ...
        migrations.AddConstraint(
            model_name='activity',
            constraint=models.UniqueConstraint(fields=('course', 'order'), name='unique activity order in course'),
        ),
        migrations.AddField(
            model_name='messagetasksubmission',
            name='activity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submissions', to='edu_lnmo.activity', verbose_name='Задание'),
        ),
    ]
