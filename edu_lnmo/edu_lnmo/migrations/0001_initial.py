    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(blank=True, related_name='students', to=settings.AUTH_USER_MODEL, verbose_name='Учащиеся')),
                ('teachers', models.ManyToManyField(blank=True, related_name='teachers', to=settings.AUTH_USER_MODEL, verbose_name='Преподаватели')),
            ],
        ),
        migrations.AddField(
            model_name='activity',
